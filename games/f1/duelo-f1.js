...
// ==========================================================================
const driversDb = [
  { name: "Lewis Hamilton", victories: 103, team: "Mercedes", nationality: "🇬🇧", color: "#00d2be", image: "./assets-f1/drivers/hamilton.png" },
  { name: "Michael Schumacher", victories: 91, team: "Ferrari", nationality: "🇩🇪", color: "#dc0000", image: "./assets-f1/drivers/schumacher.png" },
  { name: "Max Verstappen", victories: 60, team: "Red Bull Racing", nationality: "🇳🇱", color: "#3671c6", image: "./assets-f1/drivers/verstappen.png" },
  { name: "Sebastian Vettel", victories: 53, team: "Aston Martin", nationality: "🇩🇪", color: "#006f62", image: "./assets-f1/drivers/vettel.png" },
  { name: "Alain Prost", victories: 51, team: "McLaren", nationality: "🇫🇷", color: "#e8002d", image: "./assets-f1/drivers/prost.png" },
  { name: "Ayrton Senna", victories: 41, team: "McLaren", nationality: "🇧🇷", color: "#e8002d", image: "./assets-f1/drivers/senna.png" },
  { name: "Fernando Alonso", victories: 32, team: "Aston Martin", nationality: "🇪🇸", color: "#006f62", image: "./assets-f1/drivers/alonso.png" },
  { name: "Nigel Mansell", victories: 31, team: "Williams", nationality: "🇬🇧", color: "#005aff", image: "./assets-f1/drivers/mansell.png" },
  { name: "Jackie Stewart", victories: 27, team: "Tyrrell", nationality: "🇬🇧", color: "#005aff", image: "./assets-f1/drivers/stewart.png" },
  { name: "Niki Lauda", victories: 25, team: "Ferrari", nationality: "🇦🇹", color: "#dc0000", image: "./assets-f1/drivers/lauda.png" },
  { name: "Jim Clark", victories: 25, team: "Lotus", nationality: "🇬🇧", color: "#007f3e", image: "./assets-f1/drivers/clark.png" },
  { name: "Juan Manuel Fangio", victories: 24, team: "Maserati", nationality: "🇦🇷", color: "#002d62", image: "./assets-f1/drivers/fangio.png" },
  { name: "Nelson Piquet", victories: 23, team: "Brabham", nationality: "🇧🇷", color: "#002fbe", image: "./assets-f1/drivers/piquet.png" },
  { name: "Nico Rosberg", victories: 23, team: "Mercedes", nationality: "🇩🇪", color: "#00d2be", image: "./assets-f1/drivers/rosberg.png" },
  { name: "Damon Hill", victories: 22, team: "Williams", nationality: "🇬🇧", color: "#005aff", image: "./assets-f1/drivers/hill.png" },
  { name: "Kimi Räikkönen", victories: 21, team: "Ferrari", nationality: "🇫🇮", color: "#dc0000", image: "./assets-f1/drivers/raikkonen.png" },
  { name: "Mika Häkkinen", victories: 20, team: "McLaren", nationality: "🇫🇮", color: "#e8002d", image: "./assets-f1/drivers/hakkinen.png" },
  { name: "Stirling Moss", victories: 16, team: "Vanwall", nationality: "🇬🇧", color: "#005aff", image: "./assets-f1/drivers/moss.png" },
  { name: "Jenson Button", victories: 15, team: "McLaren", nationality: "🇬🇧", color: "#e8002d", image: "./assets-f1/drivers/button.png" },
  { name: "Graham Hill", victories: 14, team: "Lotus", nationality: "🇬🇧", color: "#007f3e", image: "./assets-f1/drivers/ghill.png" },
  { name: "Jack Brabham", victories: 14, team: "Brabham", nationality: "🇦🇺", color: "#005aff", image: "./assets-f1/drivers/brabham.png" },
  { name: "Emerson Fittipaldi", victories: 14, team: "Lotus", nationality: "🇧🇷", color: "#007f3e", image: "./assets-f1/drivers/fittipaldi.png" },
  { name: "Alberto Ascari", victories: 13, team: "Ferrari", nationality: "🇮🇹", color: "#dc0000", image: "./assets-f1/drivers/ascari.png" },
  { name: "David Coulthard", victories: 13, team: "McLaren", nationality: "🇬🇧", color: "#e8002d", image: "./assets-f1/drivers/coulthard.png" },
  { name: "Mario Andretti", victories: 12, team: "Lotus", nationality: "🇺🇸", color: "#007f3e", image: "./assets-f1/drivers/andretti.png" },
  { name: "Carlos Reutemann", victories: 12, team: "Ferrari", nationality: "🇦🇷", color: "#dc0000", image: "./assets-f1/drivers/reutemann.png" },
  { name: "Alan Jones", victories: 12, team: "Williams", nationality: "🇦🇺", color: "#005aff", image: "./assets-f1/drivers/jones.png" },
  { name: "Jacques Villeneuve", victories: 11, team: "Williams", nationality: "🇨🇦", color: "#005aff", image: "./assets-f1/drivers/jvilleneuve.png" },
  { name: "Felipe Massa", victories: 11, team: "Ferrari", nationality: "🇧🇷", color: "#dc0000", image: "./assets-f1/drivers/massa.png" },
  { name: "Rubens Barrichello", victories: 11, team: "Ferrari", nationality: "🇧🇷", color: "#dc0000", image: "./assets-f1/drivers/barrichello.png" },
  { name: "James Hunt", victories: 10, team: "McLaren", nationality: "🇬🇧", color: "#e8002d", image: "./assets-f1/drivers/hunt.png" },
  { name: "Gerhard Berger", victories: 10, team: "Ferrari", nationality: "🇦🇹", color: "#dc0000", image: "./assets-f1/drivers/berger.png" },
  { name: "Valtteri Bottas", victories: 10, team: "Mercedes", nationality: "🇫🇮", color: "#00d2be", image: "./assets-f1/drivers/bottas.png" },
  { name: "Mark Webber", victories: 9, team: "Red Bull Racing", nationality: "🇦🇺", color: "#3671c6", image: "./assets-f1/drivers/webber.png" },
  { name: "Charles Leclerc", victories: 8, team: "Ferrari", nationality: "🇲🇨", color: "#dc0000", image: "./assets-f1/drivers/leclerc.png" },
  { name: "Daniel Ricciardo", victories: 8, team: "Red Bull Racing", nationality: "🇦🇺", color: "#3671c6", image: "./assets-f1/drivers/ricciardo.png" },
  { name: "Juan Pablo Montoya", victories: 7, team: "Williams", nationality: "🇨🇴", color: "#005aff", image: "./assets-f1/drivers/montoya.png" },
  { name: "Gilles Villeneuve", victories: 6, team: "Ferrari", nationality: "🇨🇦", color: "#dc0000", image: "./assets-f1/drivers/gvilleneuve.png" },
  { name: "Sergio Pérez", victories: 6, team: "Red Bull Racing", nationality: "🇲🇽", color: "#3671c6", image: "./assets-f1/drivers/perez.png" },
  { name: "Keke Rosberg", victories: 5, team: "Williams", nationality: "🇫🇮", color: "#005aff", image: "./assets-f1/drivers/krosberg.png" }
];
